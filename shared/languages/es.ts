export const ES = {
   ...
   AbuSimbelDesc: "Dobla el efecto de Ramesses II. Todas las construcciones adyacentes obtienen +1 Felicidad",
   ...
   AccountLevelUpgradeConditionAnyHTML: "Para mejorar tu cuenta, solo necesitas satisfacer <b>uno de los siguientes</b> criterios:",
   AccountSupporter: "Dueño del Paquete de Colaborador",
   ...
   AccountUpgradeConfirmDescV2: "Mejorar tu cuenta <b>restablecera tu progreso de la partida actual</b> y trasladara a personajes historicos permanentes dentro de los niveles permitidos. Esto <b>no</b> puede deshacerse ¿Estas seguro que quieres continuar?",
   Acropolis: "Acrópolis",
   ...
   AircraftCarrierYard: "Puerto de Portaaviones",
   Airplane: "Avión",
   AirplaneFactory: "Fabrica de aviones",
   ...
   Colosseum: "Coliseo",
   ColosseumDesc: "Los talleres de carruajes están extentos del -1 de felicidad. Consume 10 carruajes y produce 10 de felicidad",
   ...
   HagiaSophiaDesc: "Las construcciones con un 0% de capacidad de producción no producen -1 de felicidad. Consume 10 de fé y produce 10 de felicidad",
   ...
   MogaoCavesDescV2: "+1 de felicidad por cada 10% de trabajadores ocupados. Todos los santurarios adyacentes están extentos del -1 de felicidad",
   ...
   RebornModalDescV2: "Comenzarás un nuevo imperio, pero podrás llevarte a todos los personajes históricos <b>de esta partida</b>, que se convertirán en personajes <b>permanentes</b>. También puedes elegir personajes adicionales basados en el <b>valor total del imperio</b>",
   ...
   StPetersBasilicaDesc: "Todas las construcciones que producen fé obtienen +1 multiplicador de almacenamiento. Genera fé en base a la fé almacenada.",
   Submarine: "Submarine",
   ...
   UseMirrorServerDescHTML: "Si tienes problemas accediendo al servidor principal, te puedes conectar al servidor alternativo en su lugar. <b>Es necesario reiniciar el juego para que tenga efecto</b>",
   ...
   WarpConversionDesc: "El tiempo de desconexión que exceda el máximo se convertirá a saltos de tiempo. (1 segundo = 1 salto de tiempo)",
   Water: "Agua",
